...
import (
	...
	"greenlight.johnboucha.com/internal/jsonlog"
...
func main() {
	...
	// start the server, from server.go
	err = app.serve()
	if err != nil {
		logger.PrintFatal(err, nil)
	}
...
// function to open connection to postgres and return sql.DB connection pool
